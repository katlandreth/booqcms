...
class DeviseCreateDashboardUsers < ActiveRecord::Migration
  def change
    ...
    # add_index :dashboard_users, :confirmation_token,   unique: true
    # add_index :dashboard_users, :unlock_token,         unique: true
  end
end
